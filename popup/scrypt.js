...
(function(root) {
    ...
    async function PBKDF2_HMAC_SHA256(password, salt, iterations, dkLen) {
        ...
        const derivedBits = await crypto.subtle.deriveBits(
            {
                name: 'PBKDF2',
                salt: salt, // Ensure salt is an ArrayBuffer or TypedArray
        ...
        return derivedBits; // Return as Uint8Array
    };
    ...
    async function _scrypt(password, salt, N, r, p, dkLen, callback) {
        ...
        let b = await PBKDF2_HMAC_SHA256(password, salt, 1, (p * 128 * r) / 8)
    ...
    const lib = {
        ...
        scrypt: async function(password, salt, N, r, p, dkLen) {
